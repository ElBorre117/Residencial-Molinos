/* ============================================
   CondoAdmin — Base de datos en memoria
   Reemplaza este archivo cuando conectes Supabase
   ============================================ */

const DB = {
  /* ── Usuarios del sistema ─────────────────
     role: 'admin' | 'resident'
     Para admin: sin depto
     Para resident: depto + deptoStatus + fee
  ─────────────────────────────────────────── */
  users: [
    {
      id: 1,
  ...
  /* ── Contactos del condominio ─────────────
     Edita estos números con los reales
  ─────────────────────────────────────────── */
  contacts: {
    admin: {
      name: 'Administración',
      ...
      email: 'admin@condoresidencial.com',
    ...
    emergency: [
      ...
      { label: '+52 55 6666 7777',number: '+525566667777', desc: 'Electricidad',   color: 'purple' }
    ]
  },
